...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	5e250513          	addi	a0,a0,1506 # 800610 <main+0xb2>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800052:	5e250513          	addi	a0,a0,1506 # 800630 <main+0xd2>
...
exit(int error_code) {
  ...
  8000b6:	58650513          	addi	a0,a0,1414 # 800638 <main+0xda>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001a8:	6cc78793          	addi	a5,a5,1740 # 800870 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001fc:	454a0a13          	addi	s4,s4,1108 # 80064c <main+0xee>
  ...
  800208:	5a4c0c13          	addi	s8,s8,1444 # 8007a8 <error_string>
  ...
  8002f6:	66e60613          	addi	a2,a2,1646 # 800960 <error_string+0x1b8>
  ...
  80048a:	4ca60613          	addi	a2,a2,1226 # 800950 <error_string+0x1a8>
  ...
  80049c:	4b060613          	addi	a2,a2,1200 # 800948 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  8004a0:	00000417          	auipc	s0,0x0
  8004a4:	4a940413          	addi	s0,s0,1193 # 800949 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800530:	41d40413          	addi	s0,s0,1053 # 800949 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800568:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  80056a:	b97ff0ef          	jal	ra,800100 <cprintf>
    int i;
  ...
  80059e:	a83ff0ef          	jal	ra,800020 <__panic>
  ...
  800604:	a007a023          	sw	zero,-1536(a5) # c02000 <bigarray+0x401000>
    exit(0);
  800608:	aa3ff0ef          	jal	ra,8000aa <exit>
