...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800032:	54a50513          	addi	a0,a0,1354 # 800578 <main+0x1a>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800052:	54a50513          	addi	a0,a0,1354 # 800598 <main+0x3a>
...
exit(int error_code) {
  ...
  8000b6:	4ee50513          	addi	a0,a0,1262 # 8005a0 <main+0x42>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001a8:	63478793          	addi	a5,a5,1588 # 8007d8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001fc:	3bca0a13          	addi	s4,s4,956 # 8005b4 <main+0x56>
  ...
  800208:	50cc0c13          	addi	s8,s8,1292 # 800710 <error_string>
  ...
  8002f6:	5d660613          	addi	a2,a2,1494 # 8008c8 <error_string+0x1b8>
  ...
  80048a:	43260613          	addi	a2,a2,1074 # 8008b8 <error_string+0x1a8>
  ...
  80049c:	41860613          	addi	a2,a2,1048 # 8008b0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  8004a0:	00000417          	auipc	s0,0x0
  8004a4:	41140413          	addi	s0,s0,1041 # 8008b1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800530:	38540413          	addi	s0,s0,901 # 8008b1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800572:	e406                	sd	ra,8(sp)
    panic("FAIL: T.T\n");
  800574:	aadff0ef          	jal	ra,800020 <__panic>
