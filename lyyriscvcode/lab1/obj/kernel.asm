...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200440:	bef63223          	sd	a5,-1052(a2) # 80204020 <ticks>
            if(ticks == TICK_NUM){
    ...
    8020045c:	87850513          	addi	a0,a0,-1928 # 80200cd0 <etext+0x25e>
    ...
    80200476:	b8f63f23          	sd	a5,-1122(a2) # 80204010 <edata>
                ticks = 0;
    8020047a:	00004797          	auipc	a5,0x4
    8020047e:	ba07b323          	sd	zero,-1114(a5) # 80204020 <ticks>
                if(num == 10)
    80200482:	631c                	ld	a5,0(a4)
    80200484:	fcd793e3          	bne	a5,a3,8020044a <interrupt_handler+0x84>
}
    80200488:	60a2                	ld	ra,8(sp)
    8020048a:	0141                	addi	sp,sp,16
                    sbi_shutdown();
    8020048c:	5920006f          	j	80200a1e <sbi_shutdown>
...
void exception_handler(struct trapframe *tf) {
    ...
    802004c4:	8082                	ret
    802004c6:	e9fff06f          	j	80200364 <print_trapframe>
    ...
    802004fc:	71850513          	addi	a0,a0,1816 # 80200c10 <etext+0x19e>
    80200500:	b6dff0ef          	jal	ra,8020006c <cprintf>
            cprintf("ebreak caught at 0x%08x\n",tf->epc);
    80200504:	10843583          	ld	a1,264(s0)
    80200508:	00000517          	auipc	a0,0x0
    8020050c:	72850513          	addi	a0,a0,1832 # 80200c30 <etext+0x1be>
    80200510:	b5dff0ef          	jal	ra,8020006c <cprintf>
            tf->epc+=2;
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    8020052e:	f63ff06f          	j	80200490 <exception_handler>
        interrupt_handler(tf);
    80200532:	e95ff06f          	j	802003c6 <interrupt_handler>
	...
